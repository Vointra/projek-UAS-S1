...
void SecondWindow::Timer_Update()
{
    ...
    {
        timer2_sw->stop();
        QMessageBox::information(this, "Kring!", "Timer Berhenti!");
        return;

        // Play sound when the timer finishes
        mediaPlayer->setSource(QUrl::fromLocalFile("qrc:/img1/Sound/iphone.mp3"));
        mediaPlayer->play();
    }
...
void SecondWindow::on_pushButton_2_clicked()
{
    ...
    {
        QMessageBox::warning(this, "Warning!", "Timer belum di set");
        return;
    }
